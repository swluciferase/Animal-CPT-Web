...
function showACPTReport(r) {
  ...
  const CHART_CSS = `
    ...
    .chart-box{background:#FDFAF6;border-radius:10px;padding:12px 10px;overflow:hidden;page-break-inside:avoid}
    .chart-title{font-size:.78rem;font-weight:700;color:#5C3A1E;margin-bottom:6px;text-align:center}
    .ct{width:100%;border-collapse:collapse;font-size:.7rem;margin-top:8px}
    .ct th{background:#F8F2EA;padding:3px 5px;text-align:center;font-weight:700;color:#7a6052}
    .ct td{padding:3px 5px;text-align:center;border-top:1px solid #F5EEE6}
    @media print{.chart-row{grid-template-columns:repeat(3,1fr)}.chart-box{page-break-inside:avoid}}
  `;
